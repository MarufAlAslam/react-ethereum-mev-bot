            ...
            <div className="border-2 flex flex-col gap-4 border-[#393939] p-5 rounded-r rounded-b">
                ...
                <Link to={'/subscription'} className="btn btn-green flex w-full justify-between items-center border-2 border-[#589B74] bg-[#0E1F17] rounded-md px-4 py-2">
                    <div className="flex justify-start items-center gap-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="31.971" height="37.108" viewBox="0 0 31.971 37.108">
                            <path id="Subtraction_124" data-name="Subtraction 124" d="M27.285,37.147H4.685A4.7,4.7,0,0,1,0,32.447,4.77,4.77,0,0,1,.059,31.7L1.383,14.943a4.7,4.7,0,0,1,4.68-4.426H7.319a9,9,0,0,1-.154-1.659,8.82,8.82,0,1,1,17.64,0,8.994,8.994,0,0,1-.154,1.659h1.256a4.693,4.693,0,0,1,4.679,4.438L31.912,31.7a4.8,4.8,0,0,1,.059.749,4.7,4.7,0,0,1-4.684,4.7Zm-4.409-22.2A1.657,1.657,0,1,0,24.531,16.6,1.657,1.657,0,0,0,22.876,14.943Zm-13.781,0A1.657,1.657,0,1,0,10.749,16.6,1.657,1.657,0,0,0,9.1,14.943Zm6.89-11.888A5.8,5.8,0,0,0,10.2,8.861V10.52H21.774V8.859a5.8,5.8,0,0,0-5.788-5.806Z" transform="translate(0 -0.039)" fill="#fff" />
                        </svg>
